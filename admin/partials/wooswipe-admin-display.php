...
<div id="wooswipe_admin" class="wrap">
    <div class="wooswipe_admin-main">
        ...
        <form method="post" action="#" enctype="multipart/form-data">
            ...
            <p><label><input name="white_theme" type="checkbox" value="checkbox" <?php if($options['white_theme']) _e("checked='checked'"); ?> /> Use white theme?</label></p>
            
            <div class="ps_border" ></div>
            <p><label><input name="pinterest" type="checkbox" value="checkbox" <?php if($options['pinterest']) _e("checked='checked'"); ?> /> Add Pinterest link?</label></p>

            <div class="ps_border" ></div>
            <p><label><input name="hide_thumbnails" type="checkbox" value="checkbox" <?php if($options['hide_thumbnails']) _e("checked='checked'"); ?> /> Hide thumbnails if there are no product gallery or variation images.</label></p>

            <div class="ps_border" ></div>
            <p><label><input name="product_main_slider" type="checkbox" value="checkbox" id="product_main_slider" <?php if($options['product_main_slider']) _e("checked='checked'"); ?> /> Add slider to Product main Image?</label></p>
            ...
            ?>
            <div class="ps_border" ></div>
            <p class="main_slide_nav" style="<?php _e($display_style); ?>"><label><input name="product_main_slider_nav_arrow" id="product_main_slider_nav_arrow" type="checkbox" value="checkbox" <?php if($options['product_main_slider_nav_arrow']) _e("checked='checked'"); ?> /> Add navigation arrows to the Product main image slider?</label></p>
            
            <div class="ps_border" ></div>
            <p><label><input name="remove_thumb_slider" type="checkbox" value="checkbox" <?php if($options['remove_thumb_slider']) _e("checked='checked'"); ?> /> Remove thumbnail slider completely?</label></p>
            ...
            <?php submit_button(
                __('Save Changes'),array('button-primary')
            ); ?>
